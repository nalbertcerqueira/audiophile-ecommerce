...
//Cada tipo de usuário, comum, externo e convidado (ou anônimo),
//recebe um token assinado por uma chave específica para evitar ataques de escalação de privilégios
